...
func newReport(db *gorm.DB, opts ...gen.DOOption) report {
	...
	_report.UserID = field.NewInt64(tableName, "user_id")
	_report.BlogID = field.NewInt64(tableName, "blog_id")
...
func (r *report) updateTableName(table string) *report {
	...
	r.BlogID = field.NewInt64(table, "blog_id")
