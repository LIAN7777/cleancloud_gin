...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.BlogID = field.NewInt64(tableName, "blog_id")
	...
	_comment.UserName = field.NewString(tableName, "user_name")
	_comment.ReportReason = field.NewString(tableName, "report_reason")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["blog_id"] = c.BlogID
	c.fieldMap["time"] = c.Time
	c.fieldMap["content"] = c.Content
	c.fieldMap["status"] = c.Status
	c.fieldMap["user_name"] = c.UserName
	c.fieldMap["report_reason"] = c.ReportReason
}
