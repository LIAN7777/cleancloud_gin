...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.IsReal = field.NewInt64(tableName, "is_real")
	_user.RealName = field.NewString(tableName, "real_name")
	_user.ViolateTime = field.NewInt64(tableName, "violate_time")
	...
	_user.RealID = field.NewString(tableName, "real_id")
...
func (u *user) updateTableName(table string) *user {
	...
	u.IsReal = field.NewInt64(table, "is_real")
	u.RealName = field.NewString(table, "real_name")
	u.ViolateTime = field.NewInt64(table, "violate_time")
	...
	u.RealID = field.NewString(table, "real_id")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["is_real"] = u.IsReal
	u.fieldMap["real_name"] = u.RealName
	u.fieldMap["violate_time"] = u.ViolateTime
